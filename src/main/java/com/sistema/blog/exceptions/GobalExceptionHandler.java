...
import com.sistema.blog.dtos.ErrorDetalles;
...
public class GobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetalles> manejarBlogAppException(BlogAppException blogException, WebRequest webRequest){
